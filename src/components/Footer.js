...
function Footer() {
  ...
  return (
    <div className='bg-amazon_blue  text-white flex justify-center items-center flex-col relative'>
        <div className='absolute w-full h-2 bg-gradient-to-b from-gray-100 to-amazon_blue-light top-0 z-20 mb-2' />
        {/* Logo */}
        <div onClick={ () => router.push('/')} className='pt-4 pb-2 flex items-center flex-grow  sm:flex-grow-0 bg-amazon_blue-light w-full justify-center'>
